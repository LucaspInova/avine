...
export type LojaPromotor =
  Database["public"]["Tables"]["loja_promotores"]["Row"];
export type LojaPromotorInsert =
  Database["public"]["Tables"]["loja_promotores"]["Insert"];
export type LojaPromotorUpdate =
  Database["public"]["Tables"]["loja_promotores"]["Update"];

export type LojaComPromotores =
  Database["public"]["Views"]["lojas_com_promotores"]["Row"];

export type MotivoDevolucao =
  Database["public"]["Tables"]["motivos_devolucao"]["Row"];
export type NfdDesconhecimento =
  Database["public"]["Tables"]["nfd_desconhecimentos"]["Row"];
