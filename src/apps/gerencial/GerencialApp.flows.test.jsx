...
describe('fluxo proprietário de usuários', () => {
  ...
  it('confirma ações sensíveis somente pelo modal e respeita canManage', () => {
    ...
    expect(screen.getByRole('button', { name: 'Fotos habilitadas' })).toBeDisabled()
    ...
    fireEvent.click(screen.getByRole('button', { name: 'Fotos habilitadas' }))
    expect(onTogglePhotos).toHaveBeenCalledWith(user)
