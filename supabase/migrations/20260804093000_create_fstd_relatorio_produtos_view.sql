-- Relatorio de FSTDs concluidas com uma linha por produto.
-- Para produtos com mais de um motivo, mantem o motivo com maior faturado.
-- A view usa security_invoker para manter as politicas RLS das tabelas de origem.

drop view if exists public.fstd_relatorio_produtos;

create view public.fstd_relatorio_produtos
...
comment on view public.fstd_relatorio_produtos is
  'Relatorio de FSTDs concluidas com uma linha por produto e motivo dominante por produto.';
